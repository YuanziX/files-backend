...
type QueryResolver interface {
	GetFiles(ctx context.Context, folderID string, limit int32, pageNo int32) (*model.GetFilesResponse, error)
...
func (ec *executionContext) field_Query_getFiles_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["limit"] = arg1
	arg2, err := graphql.ProcessArgField(ctx, rawArgs, "pageNo", ec.unmarshalNInt2int32)
	if err != nil {
		return nil, err
	}
	args["pageNo"] = arg2
...
func (ec *executionContext) _Query_getFiles(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			...
			return ec.resolvers.Query().GetFiles(ctx, fc.Args["folderID"].(string), fc.Args["limit"].(int32), fc.Args["pageNo"].(int32))
		},
